            ...
            <div class="swiper-wrapper" style="padding-bottom: 30px;">
                ...
                <div class="swiper-slide testimoni-card">
                    <div class="testimoni-content">
                        ...
                        <p class="testimoni-text">
                            "Keripik singkong dari Desa Pengkol renyahnya beda banget! Potongannya tipis, bumbunya merata, dan tidak berminyak sama sekali. Kemasannya juga sangat modern dan aman untuk dikirim ke luar kota."
                        </p>
                    </div>
                ...
                <div class="swiper-slide testimoni-card">
                    <div class="testimoni-content">
                        ...
                        <p class="testimoni-text">
                            "Kehadiran website katalog ini sangat membantu kelompok ibu-ibu KWT dan pengrajin lokal memasarkan hasil olahannya. Sekarang pemesanan produk singkong kami jadi jauh lebih tertata dan dikenal luas."
                        </p>
                    </div>
                    <div class="testimoni-profile">
                ...
                <div class="swiper-slide testimoni-card">
                    <div class="testimoni-content">
                        ...
                        <div class="rating-stars">⭐⭐⭐⭐⭐</div>
                        <p class="testimoni-text">
                            "Inovasi hilirisasi yang luar biasa dari mahasiswa. Produk kerupuk singkong desa yang tadinya dijual konvensional, kini naik kelas melalui digitalisasi pasar yang rapi dan informatif."
                        </p>
                    </div>
                    <div class="testimoni-profile">
                ...
                <div class="swiper-slide testimoni-card">
                    <div class="testimoni-content">
                        ...
                        <div class="rating-stars">⭐⭐⭐⭐⭐</div>
                        <p class="testimoni-text">
                            "Rasa manis gurih alami dari keripik singkong balado tradisionalnya benar-benar melekat. Sistem pemesanan lewat katalog web ini memudahkan instansi kami saat memesan dalam jumlah besar untuk oleh-oleh."
                        </p>
                    </div>
                    <div class="testimoni-profile">
...
<style>
    ...
    .testimoni-card {
        ...
        height: auto; /* Biar tinggi seragam otomatis mengikuti isi slide terpanjang */
    ...
    .testimoni-content { position: relative; }
    ...
    .avatar-dark  { background: linear-gradient(135deg, #334155, #1e293b); }
    .avatar-gold  { background: linear-gradient(135deg, #eab308, #ca8a04); }

    .profile-name { color: #0f172a; font-size: 0.95rem; font-weight: 700; display: block; }
    .profile-role { color: #64748b; font-size: 0.85rem; }
    ...
    @media (max-width: 768px) {
        .testimoni-section { padding: 60px 0; }
        .testimoni-title { font-size: 1.8rem; }
        .testimoniSwiper { padding: 10px 0 !important; }
        
        /* Sembunyikan panah di HP agar layar bersih, user bisa geser langsung sentuh jempol (swipe) */
        .swiper-button-next-custom,
        .swiper-button-prev-custom { display: none; } 
    }
</style>
        ...
        <div class="faq-accordion-wrapper">
            ...
            <div class="faq-item">
                <button class="faq-trigger">
                    <span class="faq-question">Apa yang membuat keripik singkong Desa Pengkol berbeda dengan keripik biasa?</span>
                    <span class="faq-icon-arrow"></span>
                </button>
                <div class="faq-panel">
                    <div class="faq-body">
                        <p>Keripik singkong kami diproduksi dari jenis singkong lokal pilihan hasil bumi Desa Pengkol yang terkenal memiliki tekstur empuk dan gurih alami. Dipotong dengan ketipisan yang presisi dan diolah menggunakan resep tradisional, menghasilkan keripik yang ekstra renyah, bumbu merata, dan tidak meninggalkan minyak berlebih.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item">
                <button class="faq-trigger">
                    <span class="faq-question">Apakah produk camilan singkong ini menggunakan pengawet atau pewarna kimia?</span>
                    <span class="faq-icon-arrow"></span>
                </button>
                <div class="faq-panel">
                    <div class="faq-body">
                        <p>Sama sekali tidak. Seluruh produk olahan kami, baik keripik maupun kerupuk, dijamin 100% menggunakan bahan baku alami, bebas pengawet, dan tanpa pewarna buatan. Kami memanfaatkan metode pengemasan modern kedap udara (premium packaging) untuk menjaga daya tahan produk agar tetap fresh hingga sampai ke tangan konsumen.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div class="faq-panel">
                    <div class="faq-body">
                        <p>Kami menyediakan berbagai varian rasa premium untuk memenuhi selera pasar. Mulai dari rasa Original Gurih Tradisional, Balado Pedas Manis, Keju Premium, hingga varian Kerupuk Singkong bumbu bawang yang renyah. Anda dapat melihat detail komposisi lengkapnya pada halaman katalog masing-masing produk.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div class="faq-panel">
                    <div class="faq-body">
                        <p>Pemesanan dapat dilakukan langsung dengan mengklik tombol beli pada produk yang Anda pilih di website ini. Sistem akan langsung menghubungkan Anda ke WhatsApp resmi pengrajin lokal Desa Pengkol untuk konfirmasi alamat dan total ongkos kirim. Kami siap melayani pengiriman retail (eceran) maupun pesanan dalam partai besar (grosir) ke seluruh Indonesia.</p>
                    </div>
                </div>
            </div>
...
<style>
    ...
    .faq-icon-arrow::before {
        top: 4px; left: 0; width: 8px; height: 2px;
        transform: rotate(45deg);
    }
    .faq-icon-arrow::after {
        top: 4px; right: 0; width: 8px; height: 2px;
        transform: rotate(-45deg);
    }
