...
@section('content')
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .action-buttons-grid {
                grid-template-columns: 1fr !important; /* Tombol menumpuk vertikal di HP */
                gap: 10px !important;
            }
        }
    </style>
                ...
                <div style="margin-top: 16px; display: flex; flex-direction: column; gap: 12px;">
                    ...
                    <div class="action-buttons-grid">
                        ...
                        <a href="https://tokopedia.com" 
                           target="_blank"
                           style="background-color: #03ac0e; color: #ffffff; text-decoration: none; font-weight: 700; font-size: 0.95rem; display: flex; align-items: center; justify-content: center; gap: 8px; padding: 14px 16px; border-radius: 10px; box-shadow: 0 4px 6px -1px rgba(3, 172, 14, 0.15); transition: all 0.2s; box-sizing: border-box; text-align: center;"
                        ...
                        <a href="https://wa.me/6281234567890?text=Halo%20Admin%20UMKM%20Desa%20Pengkol,%20saya%20ingin%20membeli%20produk%20{{ urlencode($product->name) }}" 
                           target="_blank"
                           style="background-color: #25d366; color: #ffffff; text-decoration: none; font-weight: 700; font-size: 0.95rem; display: flex; align-items: center; justify-content: center; gap: 8px; padding: 14px 16px; border-radius: 10px; box-shadow: 0 4px 6px -1px rgba(37, 211, 102, 0.15); transition: all 0.2s; box-sizing: border-box; text-align: center;"
                           onmouseover="this.style.backgroundColor='#20ba5a'; this.style.transform='translateY(-2px)';" 
                        ...
                        <a href="#" 
                           style="background-color: #1e293b; color: #ffffff; text-decoration: none; font-weight: 700; font-size: 0.95rem; display: flex; align-items: center; justify-content: center; gap: 8px; padding: 14px 16px; border-radius: 10px; box-shadow: 0 4px 6px -1px rgba(30, 41, 59, 0.15); transition: all 0.2s; box-sizing: border-box; text-align: center;"
                           onmouseover="this.style.backgroundColor='#0f172a'; this.style.transform='translateY(-2px)';" 
                           onmouseout="this.style.backgroundColor='#1e293b'; this.style.transform='translateY(0)';"
                           onclick="alert('Fitur pembelian langsung via Website dalam tahap integrasi sistem desa.'); return false;">
                           <svg style="width: 18px; height: 18px; fill: none; stroke: currentColor; stroke-width: 2; stroke-linecap: round; stroke-linejoin: round;" viewBox="0 0 24 24">
